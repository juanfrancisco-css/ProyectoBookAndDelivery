...
<main class="d-flex flex-nowrap">
  <h1 class="visually-hidden">Book&Delivery</h1>

  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
     
      <span class="fs-4">Book&Delivery</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="{{ route('index') }}" class="nav-link text-white" target="_blank">
            <i class="bi bi-eye"></i>
          Book&Delivery
        </a>
      </li>
      <li>
        <a href="{{ route('reserva-index') }}" class="nav-link text-white">
      ...
      <li>
        <a href="{{ route('registrarse') }}" class="nav-link text-white">
